...
import com.mindorks.framework.mvvm.ui.home.ui.home.HomeFragment

class ListAllLowonganActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun newIntent(context: Context?, mTitle: String, tipe: String? = null): Intent {
            return Intent(context, ListAllLowonganActivity::class.java).apply {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportFragmentManager
            ...
            .beginTransaction()
            // 4
            .add(R.id.content_fragment_view, HomeFragment(), "home_loker")
            // 5
            .commit()
        title = titleCourse
    }
