...
class ListAttachmentFileAdapter(var mContext: Context) : RecyclerView.Adapter<BaseViewHolder>() {
    var drop = true
    var allCheck = false
    ...
    inner class ItemListViewHolder(private val mBinding: ItemFileCreatePostBinding) :
        ...
        override fun onBind(position: Int) {
            ...
            mBinding.imageClose.setOnClickListener { view: View? ->
                mListener!!.onDeleteItemFile(position)
                notifyDataSetChanged()
            }
        ...
        fun setPost(post: AttachFileModel) {
            ...
            when (extension) {
                "doc", "docx", "rtf" -> {
                    ...
                    mBinding.editFileName.setText(post.fileName!!.replace(".$extension", ""))
                }
                "xls", "xlsx" -> {
                ...
                "jpg", "JPG", "jpeg", "JPEG", "PNG", "png", "gif", "GIF" -> {
                    ...
                    mBinding.editFileName.setText(post.fileName!!.replace("." + post.extension, ""))
                }
            }
