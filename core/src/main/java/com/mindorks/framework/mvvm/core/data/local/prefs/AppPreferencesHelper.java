...
package com.mindorks.framework.mvvm.core.data.local.prefs;
...
public class AppPreferencesHelper implements PreferencesHelper {
    ...
    private static final String PREF_KEY_CURRENT_USER_ROLES = "PREF_KEY_CURRENT_USER_ROLES";
    ...
    public String getUserRole() {
        return mPrefs.getString(PREF_KEY_CURRENT_USER_ROLES, null);
    }

    @Override
    public void setUserRole(String userRole) {
        mPrefs.edit().putString(PREF_KEY_CURRENT_USER_ROLES, userRole).apply();
    }
    ...
    public void setUserTypes(String userTypes) {
        mPrefs.edit().putString(PREF_KEY_CURRENT_USER_TYPE, userTypes).apply();
    }
}
